...
PLOTLY_LOGO = (
    "https://altitudesolutions.org/wp-content/uploads/2021/06/logo-blanco-solutions.png"
)
...
opciones_cm = ["Centro de salud", "Clínica", "Hospital"]
    ...
    [
        dbc.Row(
            [
                ...
                dbc.Col(
                    dbc.NavbarBrand(
                        "VISUALIZACIÓN DE MAPAS DE CALOR CON CONTORNOS DE DENSIDAD",
        ...
        [
            html.Div(
                [  # titulo
                    html.H6(
                        Titulo,
                        style={"padding-top": "7px", "flex": "1", "text-align": "left"},
                    ),
                ],
                style={"display": "flex"},
            ),
            dbc.InputGroup(  # boton y slider
                [
                    dbc.Button("P", color="primary", style={"flex": "0.04"}),  # boton
                    html.Div(
                        [  # div que contiene al slider
                            html.Div(
                                daq.Slider(  # Slider
                                    id=id_peso,
                                    min=0,
...
def create_dropdown_p(id_suffix, dp_options, title_dp="Title"):
    ...
    return html.Div(  # Div que contiene todo el dropdrown con el espacio de 7px
        [
            html.Div(
                [  # Div que contiene todo el dropdrown
                    html.Div(  # Div que contine el título, casilla y boton
                        [
                            html.H6(title_dp, style={"margin-bottom": "5px"}),  # Título
    ...
    for i in range(num_of_inputs):
        if i % 2 == 0:
            ...
            input_item = dbc.Row(
                [
                    dbc.Col(
                        html.H5(texts[text_index]), width=12
...
layout = html.Div(
    [
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Graph(id="map-scatter", style={"height": "100%"}),
                            ],
                            id="map-container",
                            style={
                                "display": "none",
        ...
        dbc.Offcanvas(
            dbc.Container(
                [
                    dbc.Row(dbc.Col(generate_inputs(14), width=12), justify="center"),
